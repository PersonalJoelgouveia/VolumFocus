...
const META_CARDIO_MIN = 90; // meta exemplo: 90min/semana, igual ao original
...
export function NovaSemanaView() {
  ...
  const metaCardioOk = cardio.totalMin >= META_CARDIO_MIN;
  ...
  async function handleArquivar() {
    ...
    const snapshot: HistoricoSemana = {
      ...
      weekPSE: { ...weekPSE },
      weekVol,
      tonnage: calcWeekTonnage(weekLog).kg,
      cardio,
      treinos,
      badge,
    };
      ...
      <div className="card" style={{ marginBottom: 16 }}>
        ...
        <div className="ns-cardio-grid">
          <div className="ns-stat-card">
            ...
            <div className="ns-stat-sub">{metaCardioOk ? '✅ Meta semanal atingida' : `Meta: ${META_CARDIO_MIN} min/semana`}</div>
          </div>
          <div className="ns-stat-card">
