...
export function FloatingTimerWidget() {
  ...
  function handleStop() {
    ...
    // Sucessor de ach.checkFornalha() (index.html ~10105): maior gasto
    // calórico numa única sessão de treino.
    if (finalKcal !== null) useAchievementStore.getState().checkFornalha(finalKcal, liveSeconds);
  }
